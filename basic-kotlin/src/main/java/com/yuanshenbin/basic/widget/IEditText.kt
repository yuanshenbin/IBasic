 ...
 * desc   :
 */
class IEditText : AppCompatEditText {
    ...
    constructor(context: Context?, attrs: AttributeSet?) : super(context, attrs) {
        if (attrs != null) {
            val ta = getContext().obtainStyledAttributes(attrs, R.styleable.IEditText)
            isSelectedState = ta.getBoolean(R.styleable.IEditText_i_selected, true)
            ...
            i_radius_size = ta.getDimension(R.styleable.IEditText_i_radius_size, 0f).toInt()
            i_stroke_width = ta.getDimension(R.styleable.IEditText_i_stroke_width, 0f).toInt()
            ...
            i_stroke_width_unselected = ta.getDimension(R.styleable.IEditText_i_stroke_width_unselected, 0f).toInt()
            ta.recycle()
        }
