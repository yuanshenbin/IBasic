...
//        wmParams = new WindowManager.LayoutParams();
            ...
            wmParams.width = (int) context.getResources().getDimension(R.dimen.basic_develop_mode_float_width);
            wmParams.height = (int) context.getResources().getDimension(R.dimen.basic_develop_mode_float_width);
