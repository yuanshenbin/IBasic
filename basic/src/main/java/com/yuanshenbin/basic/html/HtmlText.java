package com.yuanshenbin.basic.html;
...
import com.yuanshenbin.basic.html.span.ImageClickSpan;
import com.yuanshenbin.basic.html.span.LinkClickSpan;
...
public class HtmlText {
     ...
     * 主题色
     */
    public HtmlText setThemeColor(int themeColor) {
    ...
    public void into(TextView textView) {
        ...
        if (urlSpans != null) {
            for (URLSpan urlSpan : urlSpans) {
                ...
                if (themeColor != 0) {
                    ssb.setSpan(new ForegroundColorSpan(themeColor), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                }
