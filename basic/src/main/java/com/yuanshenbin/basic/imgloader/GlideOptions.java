...
public final class GlideOptions extends RequestOptions {
    ...
    public GlideOptions centerCrop(Context context) {
        return (GlideOptions)super.centerCrop(context);
    }
    ...
    public GlideOptions optionalCenterInside(Context context) {
        return (GlideOptions)super.optionalCenterInside(context);
    }
    ...
    public GlideOptions circleCrop(Context context) {
        return (GlideOptions)super.circleCrop(context);
    }
    ...
    public GlideOptions optionalTransform(Context context, Transformation<Bitmap> transformation) {
        return (GlideOptions)super.optionalTransform(context, transformation);
    }
