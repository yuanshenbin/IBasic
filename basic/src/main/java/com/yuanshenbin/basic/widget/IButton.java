...
public class IButton extends AppCompatButton {
    ...
    public IButton(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            i_selected = ta.getBoolean(R.styleable.IButton_i_selected, true);
            ...
            i_radius_size = (int) ta.getDimension(R.styleable.IButton_i_radius_size, 0);
            i_stroke_width = (int) ta.getDimension(R.styleable.IButton_i_stroke_width, 0);
            ...
            i_stroke_width_unselected = (int) ta.getDimension(R.styleable.IButton_i_stroke_width_unselected, 0);
            ta.recycle();
        }
