...
public class MiniLoadingWidget extends View {
    ...
    public MiniLoadingWidget(Context context) {
        this(context, null);
    }

    public MiniLoadingWidget(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.MiniLoadingStyle);
    }

    public MiniLoadingWidget(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initAttrs(context, attrs, defStyleAttr);
        initPaint();
    }

    public MiniLoadingWidget(Context context, int size, int color) {
        super(context);
        mSize = size;
        mPaintColor = color;
        initPaint();
