...
public class ProgressWheelWidget extends View {
    private static final String TAG = ProgressWheelWidget.class.getSimpleName();
     ...
     */
    public ProgressWheelWidget(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public ProgressWheelWidget(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * The constructor for the ProgressWheel
     */
    public ProgressWheelWidget(Context context) {
        super(context);
        setAnimationEnabled();
    }
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius = (int) a.getDimension(
                R.styleable.ProgressWheelWidget_matProg_circleRadius, circleRadius);

        fillRadius = a.getBoolean(R.styleable.ProgressWheelWidget_matProg_fillRadius,
                false);

        barWidth = (int) a.getDimension(
                R.styleable.ProgressWheelWidget_matProg_barWidth, barWidth);

        rimWidth = (int) a.getDimension(
                R.styleable.ProgressWheelWidget_matProg_rimWidth, rimWidth);
